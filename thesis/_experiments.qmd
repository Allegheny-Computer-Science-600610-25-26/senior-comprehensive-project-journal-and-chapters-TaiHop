...
![Path](images/test-path.png){height=80%}
...
![Results](images/test-out.png){height=80%}
...
Finally, since the database is updated every two days, validation plays a key role in ensuring that stored data reflects current PAC statistics. Below is a table of results from initial testing:

| Test | 2 days til update | 1 days til update | After update |
|------|-------------------|-------------------|--------------|
|      | 17/20             | 15/20             | 20/20        |
|      | 16/20             | 16/20             | 19/20        |
|      | 19/20             | 10/20             | 19/20        |
